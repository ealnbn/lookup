...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-g">
	<form class="am-form am-form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo U('Teacher/send')?>">
...
<!--         </div> -->
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
		<input name="tel" value="<?php echo $tel?>" type="hidden">
          ...
          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <button type="submit" class="am-btn am-btn-primary">发送短信</button>
            </div>
          </div>
      </div>
      </form>
