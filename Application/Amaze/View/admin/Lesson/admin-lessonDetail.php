		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">课程管理</strong> / <small>查看课程</small>
				</div>
			</div>
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
						<div class="am-form-group">
							...
							<div class="am-u-sm-5 am-u-end">
								<input type="text" id="name" name="name" value="<?php echo $lesson['name'];?>" placeholder="课程名字" disabled>
							</div>
						</div>
							...
							<div class="am-u-sm-9">
								<div class="am-btn-group" data-am-button>
									<label class="am-btn am-btn-default am-btn-xs <?php if($lesson['size']==0) echo "am-active"?>"> <input
										...
										type="radio" name="size" value="1" id="size2" <?php if($lesson['size']==1)echo "checked";?> disabled>组课
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-3 am-u-end">
								<input type="text" id="price" name="price" value="<?php echo $lesson['price'];?>" placeholder="价格" disabled> <small>填写数字,单位为元</small>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-8 am-u-end">
								<input type="text" id="address" value="<?php echo $address['name'];?>" name="address"
									placeholder="上课地点" disabled> <small>详细的上课地点</small>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9 ">
								<div class="am-g">
									<div class="am-u-sm-6">
										<button type="button"
											class="am-btn am-btn-default am-margin-right" id="my-start" disabled>开始日期</button>
										<span id="my-startDate"><?php echo $item['start_time'];?></span>
									</div>
									<div class="am-u-sm-6">
										<button type="button"
											class="am-btn am-btn-default am-margin-right" id="my-end" disabled>结束日期</button>
						...
						<div class="am-form-group">
						 <div class="am-g">
							...
							<div class="am-u-sm-3">
								<select id="hour" style="width:100px" disabled>
								<?php for($i=1;$i<=24;$i++){
									?>
							...
							<div class="am-u-sm-4">
								<select id="minute" style="width:100px" disabled>
								<?php for($i=1;$i<=60;$i++){ 
									?>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<textarea rows="10" id="desc" name="description"
									placeholder="输入课程简介" style="width: 700px; height: 300px;" disabled><?php echo $lesson['description'];?></textarea>
							</div>
						</div>

						<div class="am-form-group">
							<div class="am-u-sm-9 am-u-sm-push-3">
								<button type="button"  onclick="passLesson();" class="am-btn am-btn-primary" >审核通过</button>
							</div>
							<div class="am-u-sm-9 am-u-sm-push-3">
								<button type="button"  onclick="denyLesson();" class="am-btn am-btn-primary" >审核拒绝</button>
							</div>
						</div>
					</div>
				</form>
