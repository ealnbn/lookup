		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">学校管理</strong> / <small>修改学校</small>
				</div>
			</div>
			...
			<div class="am-g">
				...
				<form class="am-form am-form-horizontal" method="post"
					...
					action="<?php echo U('School/updateSchool')?>">	
					<input name="id" value="<?php echo $school['id']?>" type="hidden">
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-5 am-u-end">
								<input type="text" id="name" name="name" placeholder="学校名"
									value="<?php echo $school['name']?>"> <small>你要是不输学校的名字，我保证不打死你</small>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-6 am-u-end">
								<input type="text" id="description" name="description"
									placeholder="描述" value="<?php echo $school['description']?>"> <small></small>
							</div>
						</div>
