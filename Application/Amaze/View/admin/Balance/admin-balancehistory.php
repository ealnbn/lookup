  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-8 am-u-md-8">
				 <form id="dateForm" action="<?php echo U('Balance/dateQuery')?>"  method="post">
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-check"><input type="checkbox" /></th><th class="table-id">ID</th><th class="table-title">教师</th><th class="table-type">提现金额</th><th class="table-author am-hide-sm-only">状态</th><th class="table-date am-hide-sm-only">持卡人姓名</th><th class="table-date am-hide-sm-only">银行账号</th><th class="table-date am-hide-sm-only">开户行</th><th class="table-date am-hide-sm-only">提现时间</th><th class="table-date am-hide-sm-only">处理时间</th><th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
          <?php
          ...
          ?>
            <tr >
			  ...
			  <td class="am-hide-sm-only"><?php if($w['card']==0){echo $w['bank_account'];}else{echo $w['card_num'];}?></td>
               <td class="am-hide-sm-only"><?php if($w['card']==0){echo $w['bank_deposit'];}else{echo $w['bank_name']."-".$w['bank_detail'];}?></td>
